  ...
  return (
    <Fragment>
      ...
      <div className='w-[90%] mt-[60px] m-auto flex justify-center items-center'>
        <a href='https://github.com/Puru7071' target='_blank' className='flex flex-row justify-center items-center gap-[10px] bg-green-600 px-[15px] py-[8px] rounded-lg text-2xl text-white'>
